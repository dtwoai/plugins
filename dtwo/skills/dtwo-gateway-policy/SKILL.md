...
- **Confirm before requesting.** The request is a state change with a person on the other end of it — ask first, the same way you would before `set_intent`, and never fire one speculatively to "reset" a session.
